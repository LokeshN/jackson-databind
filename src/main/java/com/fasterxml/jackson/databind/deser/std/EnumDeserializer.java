    ...
    extends StdScalarDeserializer<Object>
{
        ...
        implements ContextualDeserializer
    {
        ...
        protected ValueInstantiator valueInstantiator;
        protected SettableBeanProperty[] creatorProps;
        ...
        public FactoryBasedDeserializer withCreatorProps(SettableBeanProperty[] creatorProps) {
        	this.creatorProps = creatorProps;
        	return this;
        }
            ...
            if (_deser != null) {
                ...
                if (p.isExpectedStartObjectToken()) {
                	...
                	if(creatorProps != null){
                		PropertyBasedCreator propertyBasedCreator = PropertyBasedCreator.construct(ctxt, valueInstantiator, creatorProps);
                		return deserializeUsingPropertyBased(p, ctxt, propertyBasedCreator);
                	}
                }
		...
		protected Object deserializeUsingPropertyBased(final JsonParser p, final DeserializationContext ctxt,
			...
			for (; t == JsonToken.FIELD_NAME; t = p.nextToken()) {
				...
				if (creatorProp != null) {
					...
					if (buffer.assignParameter(creatorProp, _deserializeWithErrorWrapping(p, ctxt, creatorProp))) {
						p.nextToken(); // to move to following
				...
				/*
				 * // regular property? needs buffering SettableBeanProperty
				 * prop = _beanProperties.find(propName); if (prop != null) {
